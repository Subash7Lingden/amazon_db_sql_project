...
-- UPDATING QUANTITY * PRICE PER UNIT
UPDATE order_items
...
SELECT 
	...
	SUM(oi.total_sale)/COUNT(o.order_id) as Avg_orders,
 	COUNT(o.order_id) as total_orders
FROM orders o
JOIN order_items oi
...
SELECT 
	...
	SUM(CASE WHEN o.order_status = 'Returned' THEN 1 ELSE 0 END)::numeric/COUNT(*)::numeric * 100 as returned_percent
FROM orders o
...
/*
17. Top 10 product with highest decreasing revenue ratio compare to last year(2022) and current_year(2023)
